...
namespace IsucorpTest.DAL.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<IsucorpTest.DAL.IsucorpTestContext>
    {
        ...
        private void InitialContacts(IsucorpTestContext context)
        {
            ...
            if (contacts <= 0)
            {
                context.Contacts.Add(new Contact { Name = "David Gilmour", PhoneNumber = "(1) 777-77771", BirthDate = new System.DateTime(1981, 05, 31), ContactTypeId = 1, ContactType = context.ContactTypes.First(x => x.Id == 1) });
                context.Contacts.Add(new Contact { Name = "Paul McCartney", PhoneNumber = "(1) 777-77772", BirthDate = new System.DateTime(1982, 06, 1), ContactTypeId = 2, ContactType = context.ContactTypes.First(x => x.Id == 2) });
                context.Contacts.Add(new Contact { Name = "Roger Waters", PhoneNumber = "(1) 777-77773", BirthDate = new System.DateTime(1983, 07, 15), ContactTypeId = 3, ContactType = context.ContactTypes.First(x => x.Id == 3) });
                context.Contacts.Add(new Contact { Name = "Paul Hewson", PhoneNumber = "(1) 777-77774", BirthDate = new System.DateTime(1984, 08, 1), ContactTypeId = 1, ContactType = context.ContactTypes.First(x => x.Id == 1) });
                context.Contacts.Add(new Contact { Name = "Robert Plant", PhoneNumber = "(1) 777-77775", BirthDate = new System.DateTime(1985, 09, 15), ContactTypeId = 2, ContactType = context.ContactTypes.First(x => x.Id == 2) });
                context.Contacts.Add(new Contact { Name = "Axl Rose", PhoneNumber = "(1) 777-77776", BirthDate = new System.DateTime(1986, 10, 1), ContactTypeId = 3, ContactType = context.ContactTypes.First(x => x.Id == 3) });
            }
            context.SaveChanges();
        }
